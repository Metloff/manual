...
Хэш функция имеет два важных показателя:
- Стаблильность. На один и тот же ключ она должна выдавать одно и то же значение.
- Хорошее распределение. При очень схожих ключах на входе, должны получаться сильно различающиеся значения на выходе.
...
## Реализации
- [GO](../../../manual/languages/go/structures/map/README.md)
